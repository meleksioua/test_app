  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(114.0, 54.0, 210.0, 106.0),
            size: Size(438.0, 860.0),
            pinTop: true,
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(6.0, 5.5, 425.3, 11.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            pinRight: true,
            pinTop: true,
            ...
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(401.0, 1.8, 24.3, 7.3),
                  size: Size(425.3, 11.0),
                  pinRight: true,
                  pinTop: true,
                  pinBottom: true,
                  fixedWidth: true,
                  child:
                    ...
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 3.0, 22.0, 1.3),
                        size: Size(24.3, 7.3),
                        pinLeft: true,
                        pinRight: true,
                        pinTop: true,
                        ...
                        child:
                          ...
                          children: <Widget>[
                            Pinned.fromSize(
                              bounds: Rect.fromLTWH(0.0, 0.0, 22.0, 1.3),
                              size: Size(22.0, 1.3),
                              child:
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(23.0, 1.7, 1.3, 4.0),
                        size: Size(24.3, 7.3),
                        pinRight: true,
                        fixedWidth: true,
                        fixedHeight: true,
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(2.0, 0.0, 18.0, 7.3),
                        size: Size(24.3, 7.3),
                        pinLeft: true,
                        fixedWidth: true,
                        fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(380.7, 0.0, 15.3, 11.0),
                  size: Size(425.3, 11.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(358.7, 0.1, 17.0, 10.7),
                  size: Size(425.3, 11.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.3, 54.0, 10.3),
                  size: Size(425.3, 11.0),
                  pinLeft: true,
                  pinTop: true,
                  pinBottom: true,
                  ...
                  child:
                    ...
                    children: <Widget>[
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(0.0, 2.2, 54.0, 6.0),
                        size: Size(54.0, 10.3),
                        pinLeft: true,
                        pinRight: true,
                        pinTop: true,
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(12.8, 0.0, 27.5, 10.3),
                        size: Size(54.0, 10.3),
                        pinLeft: true,
                        pinRight: true,
                        pinBottom: true,
          ...
          Container(),
          Pinned.fromSize(
            bounds: Rect.fromLTWH(127.0, 164.0, 185.0, 53.0),
            size: Size(438.0, 860.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(53.0, 451.0, 332.0, 52.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 332.0, 52.0),
                  size: Size(332.0, 52.0),
                  pinLeft: true,
                  pinRight: true,
                  pinTop: true,
                  pinBottom: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(20.0, 15.2, 118.0, 20.0),
                  size: Size(332.0, 52.0),
                  pinLeft: true,
                  fixedWidth: true,
                  fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(53.0, 522.0, 332.0, 52.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(20.0, 15.3, 67.0, 20.0),
                  size: Size(332.0, 52.0),
                  pinLeft: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(288.0, 18.5, 24.0, 15.1),
                  size: Size(332.0, 52.0),
                  pinRight: true,
                  fixedWidth: true,
                  fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(53.0, 607.0, 332.0, 52.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(121.0, 14.0, 90.0, 23.0),
                  size: Size(332.0, 52.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(54.0, 674.0, 123.0, 20.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(53.5, 817.5, 331.0, 1.0),
            size: Size(438.0, 860.0),
            pinLeft: true,
            pinRight: true,
            pinBottom: true,
...
const String _svg_3owq6f =
    '<svg viewBox="0.0 0.0 22.0 1.3" ><path  d="M 2.666666984558105 0 L 19.33333015441895 0 L 19.33333015441895 0 C 20.80608940124512 0 22 0.1404602378606796 22 0.3137268722057343 L 22 1.019612193107605 L 22 1.019612193107605 C 22 1.192879199981689 20.80608940124512 1.333338618278503 19.33333015441895 1.333338618278503 L 2.666666984558105 1.333338618278503 L 2.666666984558105 1.333338618278503 C 1.193907022476196 1.333338618278503 0 1.192879199981689 0 1.019612193107605 L 0 0.3137268722057343 L 0 0.3137268722057343 C 0 0.1404602378606796 1.193907022476196 0 2.666666984558105 0 Z" fill="none" stroke="#000000" stroke-width="2" stroke-opacity="0.35" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_6xi2b8 =
    '<svg viewBox="0.0 0.0 22.0 1.3" ><path transform="translate(-336.0, 26.67)" d="M 338.6666870117188 -26.66667175292969 L 355.3333129882813 -26.66667175292969 L 355.3333129882813 -26.66667175292969 C 356.8060913085938 -26.66667175292969 358 -26.52621269226074 358 -26.35294532775879 L 358 -25.64706039428711 L 358 -25.64706039428711 C 358 -25.47379302978516 356.8060913085938 -25.33333206176758 355.3333129882813 -25.33333206176758 L 338.6666870117188 -25.33333206176758 L 338.6666870117188 -25.33333206176758 C 337.1939086914063 -25.33333206176758 336 -25.47379302978516 336 -25.64706039428711 L 336 -26.35294532775879 L 336 -26.35294532775879 C 336 -26.52621269226074 337.1939086914063 -26.66667175292969 338.6666870117188 -26.66667175292969 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_wn4n6k =
    '<svg viewBox="53.5 817.5 331.0 1.0" ><path transform="translate(53.5, 817.5)" d="M 0 0 L 331 0" fill="none" fill-opacity="0.2" stroke="#1a1a1a" stroke-width="1" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="square" /></svg>';
